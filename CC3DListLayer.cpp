...
#include "CCStringParserManager.h"
...
//=============================================================
//=============================================================
void CC3DListLayer::initDataLine(float fSpaceX,float fSpaceY,CCSize itemSize,CCArray* pArray,bool bFlipY)
{
    if(!pArray)
        return;
